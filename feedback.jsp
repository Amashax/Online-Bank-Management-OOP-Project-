...
<meta charset="utf-8">
	...
	<link rel="stylesheet" href="assets/css/log.css"></link>
...
<center>
	...
	<p style="font-size:45px;">Feedback</p>
	<form action="inserttt" method="post">
	
		<div class="inbox">
	
			<lable><textarea name="feedback" rows="6" class="form-control" id="message" placeholder="Your Message" required=""></textarea>	</lable><br>
			
	
			<input type="submit" name="submit" value="send">
			<a href="Index.jsp">
			<button class="login" type="button">Logout</button>
			</a>
	</form>
